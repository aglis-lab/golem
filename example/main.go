...
import (
	...
	v1 "github.com/aglis-lab/golem/example/pkg/v1"
	"github.com/aglis-lab/golem/middleware"
...
func main() {
	...
	// Add Otel SDK
	// Setup Otel SDK
	// log.Println("Setting up OpenTelemetry SDK")
	...
	// log.Println("Setting up shutdown handler")
	// defer func() {
